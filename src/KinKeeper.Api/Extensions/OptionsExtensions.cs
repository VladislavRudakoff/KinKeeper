...
{
    public static OptionsBuilder<TOptions> AddOptionWithValidation<TOptions, TValidator>(this IServiceCollection services)
    ...
    private static OptionsBuilder<TOptions> AutoValidate<TOptions>(this OptionsBuilder<TOptions> optionsBuilder)
        where TOptions : class
    {
